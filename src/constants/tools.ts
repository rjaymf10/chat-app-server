...
export const ragFunctionDeclaration = {
  name: "rag_university_of_baguio_student_handbook", // change the function name according to what data source you uploaded.
  description: "If the user's queries are all about university of baguio student handbook.", // change the function description according to what data source you uploaded.
  parameters: {}
};